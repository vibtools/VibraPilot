...
config/                      Source-controlled application/runtime configuration and public machine contracts
  ...
  verification/              Backend, Phase-02, production and current browser-lifecycle scope contracts
...
src/vibrapilot/              Production application
  ...
  backend.py                 validated automation + production worker/runtime wiring; v1.0.6.12 adds browser lifecycle truth only
  ...
  qt_app.py                  Vib Tools PySide6 interface; v1.0.6.12 adds Task browser action/state + safe workspace geometry
