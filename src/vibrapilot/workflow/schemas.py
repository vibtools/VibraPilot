...
def builtin_share_invite_task_schema() -> WorkflowTaskSchema:
    ...
    return WorkflowTaskSchema(
        ...
        title="Share Invite Task Settings",
        inputs=(
            WorkflowFieldSchema(
                key="target_url",
                label="Target URL",
                ...
                default="",
                placeholder="https://…",
                help_text="Authenticated Share/Test Mode target URL for this Task.",
                required=True,
                role="target_url",
            ),
            WorkflowFieldSchema(
                ...
                kind="file",
                default="",
                help_text="TXT/CSV/XLSX/XLS recipient file used by the existing Share Invite parser.",
                required=True,
                role="data_file",
            ),
        ),
        metrics=(
            WorkflowMetricSchema("login", "Login", "core_login"),
            WorkflowMetricSchema("send_limit", "Send Attempts / Limit", "core_send_limit"),
            WorkflowMetricSchema("total", "Total", "core_total"),
            WorkflowMetricSchema("success", "Success", "core_success"),
            WorkflowMetricSchema("failed", "Failed", "core_failed"),
            WorkflowMetricSchema("remaining", "Remaining", "core_remaining"),
        ),
        single_item=False,
        requires_session=True,
        uses_test_send_limit=True,
    )
