...
VibraPilot v1.0.6.7 keeps public application configuration under `config/AppConfig/` and validates it through the read-only `src/vibrapilot/app_config.py` facade.
...
Authoritative public application identity/version/owner/license/platform metadata. Current release: **1.0.6.7**.
